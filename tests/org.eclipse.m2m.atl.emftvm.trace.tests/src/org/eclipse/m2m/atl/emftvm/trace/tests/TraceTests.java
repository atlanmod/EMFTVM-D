 ...
 * @generated
 */
public class TraceTests extends TestSuite {
	...
	public static Test suite() {
		TestSuite suite = new TraceTests("trace Tests");
		suite.addTestSuite(TraceLinkSetTest.class);
