...
public final class OCLOperations {
	...
	/**
	 * {@link LazyList} that resolves unique trace links within a given traced
	 * rule.
	 */
	public static class UniqueResolveList extends ResolveList {
		...
		/**
		 * Creates a new {@link UniqueResolveList} around
		 ...
		 */
		public UniqueResolveList(final Collection<Object> dataSource,
				final StackFrame frame, final String rule) {
		...
		public Iterator<Object> iterator() {
			...
			if (tr == null) {
				return new CachingIterator(dataSource.iterator()); // no need to
																	// trace
			} else {
	...
	private void createOperations() {
				...
				new String[][][] {}, new NativeCodeBlock() {
					...
					public Object execute(final StackFrame frame) {
						...
						if (object instanceof String) {
							...
							buf.append(((LazyCollection<?>) object)
									.asString(frame.getEnv()));
						} else {
							buf.append(EMFTVMUtil.toPrettyString(object,
									frame.getEnv()));
						}
		...
		createOperation(false, "toString", Types.OCL_ANY_TYPE,
				Types.STRING_TYPE, new String[][][] {}, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final Object object = frame.getLocal(0, 0);
		...
		createOperation(false, "oclAsType", Types.OCL_ANY_TYPE,
				Types.OCL_ANY_TYPE, new String[][][] { { { "type" },
						Types.CLASSIFIER_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final Object object = frame.getLocal(0, 0);
						final EClassifier type = (EClassifier) frame.getLocal(
								0, 1);
		...
		createOperation(false, "oclAsType", Types.OCL_ANY_TYPE,
				Types.OCL_ANY_TYPE, new String[][][] { { { "type" },
						Types.JAVA_CLASS_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final Object object = frame.getLocal(0, 0);
		...
		createOperation(false, "oclIsTypeOf", Types.OCL_ANY_TYPE,
				Types.BOOLEAN_TYPE, new String[][][] { { { "type" },
						Types.CLASSIFIER_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						...
						if (type instanceof EClass) {
							return o instanceof EObject
									&& ((EObject) o).eClass() == type;
						} else if (o != null) {
							final Class<?> ic = ((EClassifier) type)
									.getInstanceClass();
							if (ic == null) {
								throw new IllegalArgumentException(
										String.format(
												"EClassifier %s must have an instance class",
												type));
							}
		...
		createOperation(false, "oclIsKindOf", Types.OCL_ANY_TYPE,
				Types.BOOLEAN_TYPE, new String[][][] { { { "type" },
						Types.CLASSIFIER_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
		...
		createOperation(false, "oclType", Types.OCL_ANY_TYPE,
				Types.OCL_ANY_TYPE, new String[][][] {}, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final Object o = frame.getLocal(0, 0);
		...
		createOperation(false, "isInModel", Types.OCL_ANY_TYPE,
				Types.BOOLEAN_TYPE, new String[][][] { { { "model" },
						Types.STRING_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final Object o = frame.getLocal(0, 0);
						if (o instanceof EObject) {
							...
							if (model != null) {
								return model.getResource() == ((EObject) o)
										.eResource();
							} else {
								return false;
							}
		...
		createOperation(false, "refImmediateComposite", Types.OCL_ANY_TYPE,
				Types.OCL_ANY_TYPE, new String[][][] {}, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final Object object = frame.getLocal(0, 0);
		...
		createOperation(false, "refGetValue", Types.OCL_ANY_TYPE,
				Types.OCL_ANY_TYPE, new String[][][] { { { "propname" },
						Types.STRING_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final Object object = frame.getLocal(0, 0);
						if (object instanceof EObject) {
							final String propname = (String) frame.getLocal(0,
									1);
							final EObject eo = (EObject) object;
							final EClass ecls = eo.eClass();
							final EStructuralFeature sf = ecls
									.getEStructuralFeature(propname);
							if (sf == null) {
								throw new VMException(frame, String.format(
										"Cannot find property %s::%s",
										ecls.getName(), propname));
							}
		...
		createOperation(false, "refSetValue", Types.OCL_ANY_TYPE,
				Types.OCL_ANY_TYPE, new String[][][] {
						{ { "propname" }, Types.STRING_TYPE },
						{ { "value" }, Types.OCL_ANY_TYPE } },
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final Object object = frame.getLocal(0, 0);
		...
		createOperation(false, "refUnsetValue", Types.OCL_ANY_TYPE,
				Types.OCL_ANY_TYPE, new String[][][] { { { "propname" },
						Types.STRING_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
		...
		createOperation(false, "refInvokeOperation", Types.OCL_ANY_TYPE,
				Types.OCL_ANY_TYPE, new String[][][] {
						{ { "opname" }, Types.STRING_TYPE },
						{ { "arguments" }, Types.SEQUENCE_TYPE } },
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final Object object = frame.getLocal(0, 0);
						...
						return EMFTVMUtil.invokeNative(frame, object, opname,
								args.toArray());
					}
				});
		createOperation(false, "resolve", Types.OCL_ANY_TYPE,
				Types.OCL_ANY_TYPE, new String[][][] {}, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final Object object = frame.getLocal(0, 0);
						...
						final SourceElement se = frame.getEnv().getTraces()
								.getDefaultSourceElement(object);
						if (se != null && !se.isMapsToSelf()) {
							final EList<TargetElement> seMapsTo = se
									.getMapsTo();
							if (!seMapsTo.isEmpty()) {
								assert seMapsTo.get(0).getObject().eResource() != null;
							...
							for (TargetElement te : se.getSourceOf()
									.getTargetElements()) {
								if (te.getMapsTo().isEmpty()) { // default
																// mapping
									assert te.getObject().eResource() != null;
						...
						// TODO check object type and set something
						return object;
					}
				});
		createOperation(false, "resolve", Types.OCL_ANY_TYPE,
				Types.OCL_ANY_TYPE, new String[][][] { { { "rule" },
						Types.STRING_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final Object object = frame.getLocal(0, 0);
						final String rule = (String) frame.getLocal(0, 1);
						final TracedRule tr = frame.getEnv().getTraces()
								.getLinksByRule(rule, false);
						if (tr != null) {
							final SourceElement se = tr
									.getUniqueSourceElement(object);
							if (se != null && !se.isMapsToSelf()) {
								final EList<TargetElement> seMapsTo = se
										.getMapsTo();
								if (!seMapsTo.isEmpty()) {
									assert seMapsTo.get(0).getObject()
											.eResource() != null;
									return seMapsTo.get(0).getObject();
								}
								for (TargetElement te : se.getSourceOf()
				...
				new NativeCodeBlock() {
					...
					public Object execute(final StackFrame frame) {
						...
						if (source instanceof EObject
								...
								&& source != target) { // different physical
														// objects
							frame.getEnv().queueForRemap((EObject) source,
									(EObject) target, frame);
						}
						return target;
					}
				});
		...
		// Collection
		// ///////////////////////////////////////////////////////////////////
		createOperation(false, "toString", Types.COLLECTION_TYPE,
				Types.STRING_TYPE, new String[][][] {}, new NativeCodeBlock() {
					@SuppressWarnings("unchecked")
					@Override
					public Object execute(final StackFrame frame) {
						final LazyCollection<Object> coll = (LazyCollection<Object>) frame
								.getLocal(0, 0);
		...
		// JavaCollection
		// ///////////////////////////////////////////////////////////////////
		createOperation(false, "resolve", Types.JAVA_COLLECTION_TYPE,
				Types.SEQUENCE_TYPE, new String[][][] {},
				new NativeCodeBlock() {
					@SuppressWarnings("unchecked")
					@Override
					public Object execute(final StackFrame frame) {
						final Collection<Object> object = (Collection<Object>) frame
								.getLocal(0, 0);
						return new ResolveList(object, frame);
					}
				});
		createOperation(false, "resolve", Types.JAVA_COLLECTION_TYPE,
				Types.SEQUENCE_TYPE, new String[][][] { { { "rule" },
						Types.STRING_TYPE } }, new NativeCodeBlock() {
					@SuppressWarnings("unchecked")
					@Override
					public Object execute(final StackFrame frame) {
		...
		createOperation(false, "=~", Types.JAVA_COLLECTION_TYPE,
				Types.BOOLEAN_TYPE, new String[][][] { { { "o" },
						Types.OCL_ANY_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final Collection<?> o = (Collection<?>) frame.getLocal(
								0, 0);
						final Object o2 = frame.getLocal(0, 1);
					...
					public Object execute(final StackFrame frame) {
						...
						if (o2 instanceof Collection<?>) {
							...
							if (sizediff < 0) {
								...
								return o.subList(sizediff, o.size())
										.containsAll(coll2);
							}
						} else if (o.size() > 0) {
		...
		createOperation(false, "including", Types.MAP_TYPE, Types.SET_TYPE,
				new String[][][] { { { "key" }, Types.OCL_ANY_TYPE },
						{ { "value" }, Types.OCL_ANY_TYPE } },
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final Map<Object, Object> o = new HashMap<Object, Object>(
								(Map<?, ?>) frame.getLocal(0, 0));
		...
		createOperation(false, "getKeys", Types.MAP_TYPE, Types.SET_TYPE,
				new String[][][] {}, new NativeCodeBlock() {
					...
					public Object execute(final StackFrame frame) {
						...
						return new LazySetOnSet<Object>((Set<Object>) o
								.keySet());
					}
				});
		createOperation(false, "getValues", Types.MAP_TYPE, Types.SET_TYPE,
				new String[][][] {}, new NativeCodeBlock() {
					...
					public Object execute(final StackFrame frame) {
						final Map<?, ?> o = (Map<?, ?>) frame.getLocal(0, 0);
						return new LazyBagOnCollection<Object>(
								(Collection<Object>) o.values());
					}
				});
		...
		// ExecEnv
		// ///////////////////////////////////////////////////////////////////
		createOperation(true, "resolveTemp", Types.EXEC_ENV_TYPE,
				Types.OCL_ANY_TYPE, new String[][][] {
						{ { "var" }, Types.OCL_ANY_TYPE },
				...
				new NativeCodeBlock() {
					...
					public Object execute(final StackFrame frame) {
						...
						if (object instanceof List<?>) {
							final SourceElementList sel = frame.getEnv()
									.getTraces()
									.getDefaultSourceElements((List<?>) object);
							if (sel != null) {
								assert !sel.getSourceElements().isEmpty();
								final TargetElement te = sel
										.getSourceElements().get(0)
										.getSourceOf().getTargetElement(name);
								if (te != null) {
									return te.getObject();
								}
							}
							...
							final SourceElement se = frame.getEnv().getTraces()
									.getDefaultSourceElement(object);
							if (se != null) {
								final TargetElement te = se.getSourceOf()
						...
						throw new VMException(
								...
								String.format(
										...
										name,
										EMFTVMUtil.toPrettyString(object,
												frame.getEnv())));
					}
				});
		createOperation(true, "resolveTemp", Types.EXEC_ENV_TYPE,
					...
					public Object execute(final StackFrame frame) {
						...
						if (object instanceof List<?>) {
							final TracedRule tr = frame.getEnv().getTraces()
									.getLinksByRule(rule, false);
							if (tr != null) {
								final SourceElementList sel = tr
										.getUniqueSourceElements((List<?>) object);
								if (sel != null) {
									assert !sel.getSourceElements().isEmpty();
									final TargetElement te = sel
											.getSourceElements().get(0)
		...
		// Class
		// ///////////////////////////////////////////////////////////////////
		createOperation(false, "allInstances", Types.CLASS_TYPE,
				Types.SEQUENCE_TYPE, new String[][][] {},
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
		...
		createOperation(false, "allInstancesFrom", Types.CLASS_TYPE,
				Types.SEQUENCE_TYPE, new String[][][] { { { "metamodel" },
						Types.STRING_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final EClass c = (EClass) frame.getLocal(0, 0);
		...
		createOperation(false, "conformsTo", Types.CLASS_TYPE,
				Types.BOOLEAN_TYPE, new String[][][] { { { "type" },
						Types.CLASS_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final EClass c = (EClass) frame.getLocal(0, 0);
				...
				Types.BOOLEAN_TYPE, new String[][][] { { { "type" },
					...
					public Object execute(final StackFrame frame) {
						...
						if (ic != null) {
							...
							return c2 == Object.class; // everything is an
														// Object
						}
					}
				});
		createOperation(false, "newInstance", Types.CLASS_TYPE,
				Types.OCL_ANY_TYPE, new String[][][] {}, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
		...
		createOperation(false, "newInstanceIn", Types.CLASS_TYPE,
				Types.OCL_ANY_TYPE, new String[][][] { { { "modelname" },
						Types.STRING_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final EClass type = (EClass) frame.getLocal(0, 0);
						...
						if (model == null) {
							throw new IllegalArgumentException(String.format(
									"Inout/output model %s not found",
									modelname));
						}
						return model.newElement(type);
					}
				});
		createOperation(false, "getInstanceById", Types.CLASS_TYPE,
				Types.OCL_ANY_TYPE, new String[][][] { { { "id" },
						Types.STRING_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final EClass type = (EClass) frame.getLocal(0, 0);
						...
						final List<Model> models = new LazyListOnCollection<Model>(
								env.getInputModels().values())
								.union(new LazyListOnCollection<Model>(env
										.getInoutModels().values()));
						for (Model model : models) {
							final EObject instance = model.getResource()
									.getEObject(id);
		...
		createOperation(false, "getInstanceById", Types.CLASS_TYPE,
				Types.OCL_ANY_TYPE, new String[][][] {
						{ { "modelname" }, Types.STRING_TYPE },
						{ { "id" }, Types.STRING_TYPE } },
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final EClass type = (EClass) frame.getLocal(0, 0);
						...
						if (model == null) {
							throw new IllegalArgumentException(String
									.format("Input/inout model %s not found",
											modelname));
						}
						final EObject instance = model.getResource()
								.getEObject(id);
		...
		// JavaClass
		// ///////////////////////////////////////////////////////////////////
		createOperation(false, "conformsTo", Types.JAVA_CLASS_TYPE,
				Types.BOOLEAN_TYPE, new String[][][] { { { "type" },
						Types.CLASS_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
		...
		createOperation(false, "getName", Types.JAVA_CLASS_TYPE,
				Types.STRING_TYPE, new String[][][] {}, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final Class<?> c = (Class<?>) frame.getLocal(0, 0);
		...
		createOperation(false, "refInvokeStaticOperation",
				Types.JAVA_CLASS_TYPE, Types.OCL_ANY_TYPE, new String[][][] {
						{ { "opname" }, Types.STRING_TYPE },
						{ { "arguments" }, Types.SEQUENCE_TYPE } },
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						...
						final String opname = (String) frame.getLocal(0, 1);
						final List<?> args = (List<?>) frame.getLocal(0, 2);
						return EMFTVMUtil.invokeNativeStatic(frame, c, opname,
								args.toArray());
					}
				});
		createOperation(false, "refNewInstance", Types.JAVA_CLASS_TYPE,
				Types.OCL_ANY_TYPE, new String[][][] { { { "arguments" },
						Types.SEQUENCE_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final Class<?> c = (Class<?>) frame.getLocal(0, 0);
						final Object[] args = ((List<?>) frame.getLocal(0, 1))
								.toArray();
						final Constructor<?> constructor = EMFTVMUtil
								.findConstructor(c,
										EMFTVMUtil.getArgumentClasses(args));
						if (constructor != null) {
							try {
								return EMFTVMUtil.emf2vm(frame.getEnv(), null,
						...
						throw new UnsupportedOperationException(String.format(
								"%s::<init>(%s)", EMFTVMUtil.getTypeName(
										frame.getEnv(), c),
								EMFTVMUtil.getTypeNames(frame.getEnv(),
				...
				new String[][][] {}, new NativeCodeBlock() {
					...
					public Object execute(final StackFrame frame) {
						return Double.valueOf(
								Math.floor((Double) frame.getLocal(0, 0)))
								.intValue();
					}
				});
		createOperation(false, "round", Types.REAL_TYPE, Types.INTEGER_TYPE,
				new String[][][] {}, new NativeCodeBlock() {
					...
					public Object execute(final StackFrame frame) {
						return Double.valueOf(
								Math.round((Double) frame.getLocal(0, 0)))
								.intValue();
					}
				});
		createOperation(false, "max", Types.REAL_TYPE, Types.REAL_TYPE,
				...
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						return Math.max((Double) frame.getLocal(0, 0),
								(Double) frame.getLocal(0, 1));
					}
				});
		createOperation(false, "max", Types.REAL_TYPE, Types.REAL_TYPE,
		...
		createOperation(false, "min", Types.REAL_TYPE, Types.REAL_TYPE,
				...
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						return Math.min((Double) frame.getLocal(0, 0),
								(Double) frame.getLocal(0, 1));
					}
				});
		createOperation(false, "min", Types.REAL_TYPE, Types.REAL_TYPE,
		...
		createOperation(false, "<", Types.REAL_TYPE, Types.BOOLEAN_TYPE,
				...
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						return (Double) frame.getLocal(0, 0) < (Double) frame
								.getLocal(0, 1);
					}
				});
		createOperation(false, "<", Types.REAL_TYPE, Types.BOOLEAN_TYPE,
				...
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						return (Double) frame.getLocal(0, 0) < (Integer) frame
								.getLocal(0, 1);
					}
				});
		createOperation(false, ">", Types.REAL_TYPE, Types.BOOLEAN_TYPE,
		...
		createOperation(false, "/", Types.INTEGER_TYPE, Types.REAL_TYPE,
				...
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						return ((Integer) frame.getLocal(0, 0)).doubleValue()
								/ (Integer) frame.getLocal(0, 1);
					}
				});
		...
		createOperation(false, "max", Types.INTEGER_TYPE, Types.REAL_TYPE,
				...
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						return Math.max((Integer) frame.getLocal(0, 0),
								(Double) frame.getLocal(0, 1));
		...
		createOperation(false, "min", Types.INTEGER_TYPE, Types.REAL_TYPE,
				...
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						return Math.min((Integer) frame.getLocal(0, 0),
								(Double) frame.getLocal(0, 1));
					}
				});
		...
		createOperation(false, "<", Types.INTEGER_TYPE, Types.BOOLEAN_TYPE,
				...
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						return (Integer) frame.getLocal(0, 0) < (Double) frame
								.getLocal(0, 1);
					}
				});
		createOperation(false, "<", Types.INTEGER_TYPE, Types.BOOLEAN_TYPE,
				...
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						return (Integer) frame.getLocal(0, 0) < (Integer) frame
								.getLocal(0, 1);
		...
		createOperation(false, "+", Types.STRING_TYPE, Types.STRING_TYPE,
				...
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						return (String) frame.getLocal(0, 0)
								+ (String) frame.getLocal(0, 1);
					}
				});
		...
		createOperation(false, "substring", Types.STRING_TYPE,
				Types.STRING_TYPE, new String[][][] { { { "lower" },
						Types.INTEGER_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						try {
							return ((String) frame.getLocal(0, 0))
									.substring((Integer) frame.getLocal(0, 1) - 1);
		...
		createOperation(false, "substring", Types.STRING_TYPE,
				Types.STRING_TYPE, new String[][][] {
						{ { "lower" }, Types.INTEGER_TYPE },
						{ { "upper" }, Types.INTEGER_TYPE } },
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						try {
		...
		createOperation(false, "toInteger", Types.STRING_TYPE,
				Types.INTEGER_TYPE, new String[][][] {}, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						try {
							return Integer.parseInt((String) frame.getLocal(0,
									0));
		...
		createOperation(false, "toReal", Types.STRING_TYPE, Types.REAL_TYPE,
				new String[][][] {}, new NativeCodeBlock() {
					...
					public Object execute(final StackFrame frame) {
						try {
							return Double.parseDouble((String) frame.getLocal(
									0, 0));
						} catch (NumberFormatException e) {
							throw new VMException(frame, e);
						}
		...
		createOperation(false, "indexOf", Types.STRING_TYPE,
				Types.INTEGER_TYPE, new String[][][] { { { "s" },
						Types.STRING_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						return ((String) frame.getLocal(0, 0))
								.indexOf((String) frame.getLocal(0, 1)) + 1;
					}
				});
		createOperation(false, "lastIndexOf", Types.STRING_TYPE,
				Types.INTEGER_TYPE, new String[][][] { { { "s" },
						Types.STRING_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						return ((String) frame.getLocal(0, 0))
								.lastIndexOf((String) frame.getLocal(0, 1)) + 1;
					}
				});
		createOperation(false, "at", Types.STRING_TYPE, Types.STRING_TYPE,
				...
				new NativeCodeBlock() {
					...
					public Object execute(final StackFrame frame) {
						try {
							return String.valueOf(((String) frame
									.getLocal(0, 0)).charAt((Integer) frame
									.getLocal(0, 1) - 1));
						} catch (IndexOutOfBoundsException e) {
							throw new VMException(frame, e);
						}
		...
		createOperation(false, "characters", Types.STRING_TYPE,
				Types.SEQUENCE_TYPE, new String[][][] {},
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						LazyList<String> seq = new LazyList<String>();
						for (char c : ((String) frame.getLocal(0, 0))
								.toCharArray()) {
		...
		createOperation(false, "toBoolean", Types.STRING_TYPE,
				Types.BOOLEAN_TYPE, new String[][][] {}, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						return Boolean.parseBoolean((String) frame.getLocal(0,
								0));
					}
				});
		...
		createOperation(false, "writeTo", Types.STRING_TYPE,
				Types.BOOLEAN_TYPE, new String[][][] { { { "path" },
						Types.STRING_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						try {
							return EMFTVMUtil.writeToWithCharset(
									...
									(String) frame.getLocal(0, 1), null);
		...
		createOperation(false, "writeToWithCharset", Types.STRING_TYPE,
				Types.BOOLEAN_TYPE, new String[][][] {
						{ { "path" }, Types.STRING_TYPE },
						{ { "charset" }, Types.STRING_TYPE } },
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						try {
		...
		createOperation(false, "toDate", Types.STRING_TYPE,
				Types.JAVA_DATE_TYPE, new String[][][] { { { "format" },
						Types.STRING_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						try {
							return new SimpleDateFormat((String) frame
									.getLocal(1)).parse((String) frame
									.getLocal(0));
		...
		createOperation(false, "toDate", Types.STRING_TYPE,
				Types.JAVA_DATE_TYPE, new String[][][] {
						{ { "format" }, Types.STRING_TYPE },
						{ { "locale" }, Types.STRING_TYPE } },
				new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						try {
							return new SimpleDateFormat((String) frame
									.getLocal(1), EMFTVMUtil
									.getLocale((String) frame.getLocal(2)))
		...
		// Date
		// ///////////////////////////////////////////////////////////////////
		createOperation(false, "toString", Types.JAVA_DATE_TYPE,
				Types.STRING_TYPE, new String[][][] { { { "format" },
						Types.STRING_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						return new SimpleDateFormat((String) frame.getLocal(1))
				...
				new NativeCodeBlock() {
					...
					public Object execute(final StackFrame frame) {
						return new SimpleDateFormat(
								(String) frame.getLocal(1),
								EMFTVMUtil.getLocale((String) frame.getLocal(2)))
								.format((Date) frame.getLocal(0));
					}
				});
		createOperation(false, "toTuple", Types.JAVA_DATE_TYPE,
				Types.TUPLE_TYPE, new String[][][] {}, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
		...
		createOperation(false, "toTuple", Types.JAVA_DATE_TYPE,
				Types.TUPLE_TYPE, new String[][][] { { { "timezone" },
						Types.STRING_TYPE } }, new NativeCodeBlock() {
					@Override
					public Object execute(final StackFrame frame) {
						final Calendar cal = Calendar.getInstance(TimeZone
								.getTimeZone((String) frame.getLocal(1)));
						cal.setTime((Date) frame.getLocal(0));
						return Tuple.fromCalendar(cal);
					}
				});
	 ...
	 * @see Types
	 */
	private Operation createOperation(final boolean isStatic,
			final String name, final String[] context,
			final String[] returnType, final String[][][] parameters,
			final CodeBlock body) {
		final Operation op = EMFTVMUtil.createOperation(isStatic, name,
				context, returnType, parameters, body);
