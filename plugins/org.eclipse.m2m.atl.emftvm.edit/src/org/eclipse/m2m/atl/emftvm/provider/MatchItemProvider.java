...
/**
 * This is the item provider adapter for a {@link org.eclipse.m2m.atl.emftvm.Match} object.
 * <!-- begin-user-doc -->
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Match_rulename_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Match_rulename_feature", "_UI_Match_type"),
				 EmftvmPackage.Literals.MATCH__RULENAME,
				 true,
				 false,
				 false,
