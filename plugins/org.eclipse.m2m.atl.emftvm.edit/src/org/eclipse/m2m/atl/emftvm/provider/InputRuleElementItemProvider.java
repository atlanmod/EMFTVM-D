...
/**
 * This is the item provider adapter for a {@link org.eclipse.m2m.atl.emftvm.InputRuleElement} object.
 * <!-- begin-user-doc -->
...
public class InputRuleElementItemProvider
	 ...
	 * @generated
	 */
	public InputRuleElementItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EmftvmPackage.Literals.INPUT_RULE_ELEMENT__BINDING);
		}
	...
	/**
	 * This returns InputRuleElement.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/InputRuleElement"));
	}
	...
	public String getText(Object object) {
		String label = ((InputRuleElement)object).toString();
		return label == null || label.length() == 0 ?
			getString("_UI_InputRuleElement_type") :
			getString("_UI_InputRuleElement_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EmftvmPackage.Literals.INPUT_RULE_ELEMENT__BINDING,
