...
/**
 * This is the item provider adapter for a {@link org.eclipse.m2m.atl.emftvm.Field} object.
 * <!-- begin-user-doc -->
...
public class FieldItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Field_staticValue_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Field_staticValue_feature", "_UI_Field_type"),
				 EmftvmPackage.Literals.FIELD__STATIC_VALUE,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EmftvmPackage.Literals.FIELD__INITIALISER);
		}
	...
	public String getText(Object object) {
		String label = ((Field)object).toString();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EmftvmPackage.Literals.FIELD__INITIALISER,
