...
import org.eclipse.m2m.atl.emftvm.ftrace.impl.FTracePackageImpl;
...
public class TracePackageImpl extends EPackageImpl implements TracePackage {
	...
	public static TracePackage init() {
		...
		FTracePackageImpl theFTracePackage = (FTracePackageImpl)(EPackage.Registry.INSTANCE.getEPackage(FTracePackage.eNS_URI) instanceof FTracePackageImpl ? EPackage.Registry.INSTANCE.getEPackage(FTracePackage.eNS_URI) : FTracePackage.eINSTANCE);
	 ...
	 * @generated
	 */
	public EOperation getTraceLinkSet__GetDefaultSourceElement__Object() {
		return traceLinkSetEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getTraceLinkSet__GetDefaultSourceElements__List() {
		return traceLinkSetEClass.getEOperations().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getTraceLinkSet__GetLinksByRule__String_boolean() {
		return traceLinkSetEClass.getEOperations().get(2);
	}
	 ...
	 * @generated
	 */
	public EOperation getTraceLinkSet__Clear() {
		return traceLinkSetEClass.getEOperations().get(3);
	}
	 ...
	 * @generated
	 */
	public EOperation getTracedRule__GetUniqueSourceElement__Object() {
		return tracedRuleEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getTracedRule__GetUniqueSourceElements__List() {
		return tracedRuleEClass.getEOperations().get(1);
	}
	 ...
	 * @generated
	 */
	public EOperation getTraceLink__GetSourceElement__String_boolean() {
	 ...
	 * @generated
	 */
	public EOperation getTraceLink__GetTargetElement__String() {
	 ...
	 * @generated
	 */
	public EOperation getSourceElementList__GetSourceObjects() {
		return sourceElementListEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getTraceProperty__ResolveBinding__TraceLinkSet() {
	...
	public void createPackageContents() {
		...
		createEOperation(traceLinkSetEClass, TRACE_LINK_SET___GET_DEFAULT_SOURCE_ELEMENT__OBJECT);
		createEOperation(traceLinkSetEClass, TRACE_LINK_SET___GET_DEFAULT_SOURCE_ELEMENTS__LIST);
		createEOperation(traceLinkSetEClass, TRACE_LINK_SET___GET_LINKS_BY_RULE__STRING_BOOLEAN);
		createEOperation(traceLinkSetEClass, TRACE_LINK_SET___CLEAR);
		...
		createEOperation(tracedRuleEClass, TRACED_RULE___GET_UNIQUE_SOURCE_ELEMENT__OBJECT);
		createEOperation(tracedRuleEClass, TRACED_RULE___GET_UNIQUE_SOURCE_ELEMENTS__LIST);
		...
		createEOperation(traceLinkEClass, TRACE_LINK___GET_SOURCE_ELEMENT__STRING_BOOLEAN);
		createEOperation(traceLinkEClass, TRACE_LINK___GET_TARGET_ELEMENT__STRING);
		...
		createEOperation(sourceElementListEClass, SOURCE_ELEMENT_LIST___GET_SOURCE_OBJECTS);
		...
		createEOperation(tracePropertyEClass, TRACE_PROPERTY___RESOLVE_BINDING__TRACELINKSET);
	...
	public void initializePackageContents() {
		...
		EOperation op = initEOperation(getTraceLinkSet__GetDefaultSourceElement__Object(), this.getSourceElement(), "getDefaultSourceElement", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEJavaObject(), "sourceElement", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getTraceLinkSet__GetDefaultSourceElements__List(), this.getSourceElementList(), "getDefaultSourceElements", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getTraceLinkSet__GetLinksByRule__String_boolean(), this.getTracedRule(), "getLinksByRule", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getTraceLinkSet__Clear(), null, "clear", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getTracedRule__GetUniqueSourceElement__Object(), this.getSourceElement(), "getUniqueSourceElement", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEJavaObject(), "sourceElement", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getTracedRule__GetUniqueSourceElements__List(), this.getSourceElementList(), "getUniqueSourceElements", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getTraceLink__GetSourceElement__String_boolean(), this.getSourceElement(), "getSourceElement", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "name", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEBoolean(), "create", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getTraceLink__GetTargetElement__String(), this.getTargetElement(), "getTargetElement", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEString(), "name", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getSourceElementList__GetSourceObjects(), ecorePackage.getEJavaObject(), "getSourceObjects", 2, -1, IS_UNIQUE, IS_ORDERED);
		...
		op = initEOperation(getTraceProperty__ResolveBinding__TraceLinkSet(), null, "resolveBinding", 0, 1, IS_UNIQUE, IS_ORDERED);
